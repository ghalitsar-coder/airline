...
('11000000-0000-0000-0000-000000000001', 'af000001-0000-0000-0000-000000000001', 'af000001-0000-0000-0000-000000000002', 980, 115),
('11000000-0000-0000-0000-000000000002', 'af000001-0000-0000-0000-000000000001', 'af000001-0000-0000-0000-000000000003', 690, 90),
('11000000-0000-0000-0000-000000000003', 'af000001-0000-0000-0000-000000000001', 'af000001-0000-0000-0000-000000000004', 900, 105),
('11000000-0000-0000-0000-000000000004', 'af000001-0000-0000-0000-000000000001', 'af000001-0000-0000-0000-000000000005', 1180, 135),
('11000000-0000-0000-0000-000000000005', 'af000001-0000-0000-0000-000000000001', 'af000001-0000-0000-0000-000000000006', 5500, 420);
...
('f0000000-0000-0000-0000-000000000001', 'NA101', '11000000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000001', '2025-05-01 06:00:00+07', '2025-05-01 08:00:00+08', 'SCHEDULED'),
('f0000000-0000-0000-0000-000000000002', 'NA102', '11000000-0000-0000-0000-000000000002', 'a2000000-0000-0000-0000-000000000002', '2025-05-01 07:00:00+07', '2025-05-01 08:30:00+07', 'SCHEDULED'),
('f0000000-0000-0000-0000-000000000003', 'NA103', '11000000-0000-0000-0000-000000000003', 'a2000000-0000-0000-0000-000000000003', '2025-05-01 09:00:00+07', '2025-05-01 11:45:00+08', 'BOARDING'),
('f0000000-0000-0000-0000-000000000004', 'NA104', '11000000-0000-0000-0000-000000000004', 'a2000000-0000-0000-0000-000000000005', '2025-05-02 14:00:00+07', '2025-05-02 16:15:00+08', 'SCHEDULED'),
('f0000000-0000-0000-0000-000000000005', 'NA105', '11000000-0000-0000-0000-000000000005', 'a2000000-0000-0000-0000-000000000005', '2025-05-03 22:00:00+07', '2025-05-04 07:00:00+09', 'SCHEDULED');
...
('f0000000-0000-0000-0000-000000000001', 'ECONOMY', 'Y', 850000, 93500, '2027-04-30 23:59:59+07'),
('f0000000-0000-0000-0000-000000000001', 'ECONOMY', 'B', 1200000, 132000, '2027-04-30 23:59:59+07'),
('f0000000-0000-0000-0000-000000000001', 'BUSINESS', 'C', 2500000, 275000, '2027-04-30 23:59:59+07'),
('f0000000-0000-0000-0000-000000000003', 'ECONOMY', 'Y', 950000, 104500, '2027-04-30 23:59:59+07'),
('f0000000-0000-0000-0000-000000000005', 'BUSINESS', 'C', 4500000, 495000, '2027-05-03 23:59:59+07');
...
('e1000000-0000-0000-0000-000000000001', 'EARLYBIRD10', 'PERCENTAGE', 10, '2025-01-01', '2027-06-30', true),
('e1000000-0000-0000-0000-000000000002', 'FLASH50', 'FIXED', 50000, '2025-04-01', '2027-04-30', true);
...
('e2000000-0000-0000-0000-000000000001', 'PPN', 11, true),
('e2000000-0000-0000-0000-000000000002', 'PJKP2U', 5, true);
...
('b4000001-0000-0000-0000-000000000001', 'NA1234', 'b0000000-0000-0000-0000-000000000001', NOW(), 'CONFIRMED', 943500, 'IDR'),
('b4000001-0000-0000-0000-000000000002', 'NA1235', 'b0000000-0000-0000-0000-000000000002', NOW(), 'CONFIRMED', 943500, 'IDR');
...
('b5000001-0000-0000-0000-000000000001', 'b4000001-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'ADULT', 'Ahmad', 'Santoso'),
('b5000001-0000-0000-0000-000000000002', 'b4000001-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', 'ADULT', 'Dewi', 'Kartika');
...
('b6000001-0000-0000-0000-000000000001', 'b4000001-0000-0000-0000-000000000001', 'b5000001-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001', NULL, NULL, 'ECONOMY', 'CONFIRMED'),
('b6000001-0000-0000-0000-000000000002', 'b4000001-0000-0000-0000-000000000002', 'b5000001-0000-0000-0000-000000000002', 'f0000000-0000-0000-0000-000000000001', NULL, NULL, 'ECONOMY', 'CONFIRMED');
...
('b6000001-0000-0000-0000-000000000001', 'ONLINE');
...
('b6000001-0000-0000-0000-000000000001', 'BAG001', 15.0, 'CHECKED');
...
('b4000001-0000-0000-0000-000000000001', 'CREDIT_CARD', 'COMPLETED', 943500);
...
('b4000001-0000-0000-0000-000000000001', 'f0000000-0000-0000-0000-000000000001', 'TICKET', 850000, 93500);
...
('1a000001-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', 'FF-b0000000', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000002', 'b0000000-0000-0000-0000-000000000002', 'FF-b0000001', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000003', 'b0000000-0000-0000-0000-000000000003', 'FF-b0000002', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000004', 'b0000000-0000-0000-0000-000000000004', 'FF-b0000003', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000005', 'b0000000-0000-0000-0000-000000000005', 'FF-b0000004', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000006', 'b0000000-0000-0000-0000-000000000006', 'FF-b0000005', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000007', 'b0000000-0000-0000-0000-000000000007', 'FF-b0000006', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000008', 'b0000000-0000-0000-0000-000000000008', 'FF-b0000007', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000009', 'b0000000-0000-0000-0000-000000000009', 'FF-b0000008', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000010', 'b0000000-0000-0000-0000-000000000010', 'FF-b0000009', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000011', 'b0000000-0000-0000-0000-000000000011', 'FF-b0000010', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000012', 'b0000000-0000-0000-0000-000000000012', 'FF-b0000011', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000013', 'b0000000-0000-0000-0000-000000000013', 'FF-b0000012', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000014', 'b0000000-0000-0000-0000-000000000014', 'FF-b0000013', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000015', 'b0000000-0000-0000-0000-000000000015', 'FF-b0000014', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000016', 'b0000000-0000-0000-0000-000000000016', 'FF-b0000015', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000017', 'b0000000-0000-0000-0000-000000000017', 'FF-b0000016', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000018', 'b0000000-0000-0000-0000-000000000018', 'FF-b0000017', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000019', 'b0000000-0000-0000-0000-000000000019', 'FF-b0000018', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000020', 'b0000000-0000-0000-0000-000000000020', 'FF-b0000019', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000021', 'b0000000-0000-0000-0000-000000000021', 'FF-b0000020', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000022', 'b0000000-0000-0000-0000-000000000022', 'FF-b0000021', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000023', 'b0000000-0000-0000-0000-000000000023', 'FF-b0000022', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000024', 'b0000000-0000-0000-0000-000000000024', 'FF-b0000023', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000025', 'b0000000-0000-0000-0000-000000000025', 'FF-b0000024', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000026', 'b0000000-0000-0000-0000-000000000026', 'FF-b0000025', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000027', 'b0000000-0000-0000-0000-000000000027', 'FF-b0000026', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000028', 'b0000000-0000-0000-0000-000000000028', 'FF-b0000027', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000029', 'b0000000-0000-0000-0000-000000000029', 'FF-b0000028', 'BASIC', 5000),
('1a000001-0000-0000-0000-000000000030', 'b0000000-0000-0000-0000-000000000030', 'FF-b0000029', 'BASIC', 5000);
...
('c4000001-0000-0000-0000-000000000001', 'e0000000-0000-0000-0000-000000000001', 'CAPTAIN', 'ATP-001'),
('c4000001-0000-0000-0000-000000000002', 'e0000000-0000-0000-0000-000000000002', 'FIRST_OFFICER', 'CPL-001'),
('c4000001-0000-0000-0000-000000000003', 'e0000000-0000-0000-0000-000000000003', 'PURSER', NULL);
...
('f0000000-0000-0000-0000-000000000001', 'c4000001-0000-0000-0000-000000000001', 'CAPTAIN', true),
('f0000000-0000-0000-0000-000000000001', 'c4000001-0000-0000-0000-000000000002', 'FIRST_OFFICER', true);
...
('d1000000-0000-0000-0000-000000000001', 'a2000000-0000-0000-0000-000000000004', 'ROUTINE_A', 'IN_PROGRESS');
